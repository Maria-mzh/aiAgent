---
name: figma
description: Professional Figma design analysis and asset export. Use for extracting design data, exporting assets in multiple formats, auditing accessibility compliance, analyzing design systems, and generating comprehensive design documentation. Read-only analysis of Figma files with powerful export and reporting capabilities.专业的Figma设计分析和资源导出。用于提取设计数据、以多种格式导出资源、审核可访问性合规性、分析设计系统以及生成全面的设计文档。对Figma文件进行只读分析，同时具备强大的导出和报告功能。
---
